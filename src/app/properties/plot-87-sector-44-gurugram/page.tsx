    ...
    <>
          ...
          <div className="overflow-x-auto">
            <table className="w-full max-w-3xl text-sm border border-gray-200 rounded-lg overflow-hidden">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr><td className="px-4 py-3 font-medium">Basement</td><td className="px-4 py-3">~5,300 sq. ft.</td><td className="px-4 py-3">₹50/sq. ft.</td><td className="px-4 py-3">Storage, back-office, server rooms</td></tr>
                <tr className="bg-gray-50"><td className="px-4 py-3 font-medium">Ground</td><td className="px-4 py-3">~5,300 sq. ft.</td><td className="px-4 py-3">₹85/sq. ft.</td><td className="px-4 py-3">Retail, reception, showroom</td></tr>
                <tr><td className="px-4 py-3 font-medium">1st Floor</td><td className="px-4 py-3">~5,300 sq. ft.</td><td className="px-4 py-3">₹160/sq. ft.</td><td className="px-4 py-3 text-blue-700 font-medium">Double-height (20 ft) — flagship offices, showrooms</td></tr>
                <tr className="bg-gray-50"><td className="px-4 py-3 font-medium">2nd Floor</td><td className="px-4 py-3">~5,300 sq. ft.</td><td className="px-4 py-3">₹160/sq. ft.</td><td className="px-4 py-3 text-blue-700 font-medium">Double-height (20 ft) — training centres, studios</td></tr>
                ...
                <tr className="bg-gray-50"><td className="px-4 py-3 font-medium">4th Floor</td><td className="px-4 py-3">~5,300 sq. ft.</td><td className="px-4 py-3">₹85/sq. ft.</td><td className="px-4 py-3">Corporate offices</td></tr>
                <tr className="bg-blue-50"><td className="px-4 py-3 font-bold">Full Building</td><td className="px-4 py-3 font-bold">~25,000 sq. ft.</td><td className="px-4 py-3 font-bold">~₹75/sq. ft. (negotiable)</td><td className="px-4 py-3 font-bold">Single-tenant headquarters</td></tr>
              </tbody>
            </table>
          </div>
        </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
            {[
              { title: 'Standalone Building', desc: 'Entire institutional-zoned building with modern stone facade, north-facing. Complete branding and signage freedom.' },
      ...
      <section className="py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-3">
            {['Mid-size IT Companies', 'BFSI Firms', 'Healthcare & EdTech', 'Media & Production', 'Coworking Operators', 'Startups (50–200 employees)', 'Training Centres', 'Showrooms'].map((item) => (
